module github.com/SimCubeLtd/pulumi-nexus/provider
...
require (
	github.com/datadrivers/terraform-provider-nexus v1.18.0
...
require (
	...
	github.com/datadrivers/go-nexus-client v1.3.4 // indirect
