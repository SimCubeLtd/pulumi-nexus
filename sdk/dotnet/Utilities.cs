...
namespace Pulumi.Nexus
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/SimCubeLtd/pulumi-nexus/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Nexus.version.txt");
    ...
    internal sealed class NexusResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public NexusResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
