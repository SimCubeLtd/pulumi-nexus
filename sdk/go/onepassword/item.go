...
//
// import (
// 	"github.com/SimCubeLtd/pulumi-nexus/sdk/go/nexus"
// 	"github.com/pulumi/pulumi-nexus/sdk/go/nexus"
// 	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
// )
//
// func main() {
// 	pulumi.Run(func(ctx *pulumi.Context) error {
// 		_, err := nexus.NewItem(ctx, "demoPassword", &nexus.ItemArgs{
...
// 			return err
// 		}
// 		_, err = nexus.NewItem(ctx, "demoLogin", &nexus.ItemArgs{
// 			Vault:    pulumi.Any(_var.Demo_vault),
...
// 			return err
// 		}
// 		_, err = nexus.NewItem(ctx, "demoDb", &nexus.ItemArgs{
// 			Vault:    pulumi.Any(_var.Demo_vault),
...
func NewItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.RegisterResource("nexus:index/item:Item", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.ReadResource("nexus:index/item:Item", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
