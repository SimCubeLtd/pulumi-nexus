 ...
 * ```typescript
 * import * as pulumi from "@pulumi/pulumi";
 * import * as pulumi_nexus from "@simcubeltd/pulumi-nexus";
 *
 * const demoPassword = new nexus.Item("demoPassword", {
 ...
 *     },
 * });
 * const demoLogin = new nexus.Item("demoLogin", {
 *     vault: _var.demo_vault,
 *     title: "Demo Terraform Login",
 *     category: "login",
 *     username: "test@example.com",
 * });
 * const demoDb = new nexus.Item("demoDb", {
 *     vault: _var.demo_vault,
 *     category: "database",
 *     type: "mysql",
...
export class Item extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'nexus:index/item:Item';
