...
export class NexusBlobstoreGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NexusBlobstoreGroupState, opts?: pulumi.CustomResourceOptions): NexusBlobstoreGroup {
        return new NexusBlobstoreGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/nexusBlobstoreGroup:NexusBlobstoreGroup';

    /**
     * Returns true if the given object is an instance of NexusBlobstoreGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NexusBlobstoreGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NexusBlobstoreGroup.__pulumiType;
    }
     ...
     */
    public readonly softQuota!: pulumi.Output<outputs.NexusBlobstoreGroupSoftQuota | undefined>;
    /**
     ...
     */
    constructor(name: string, args: NexusBlobstoreGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NexusBlobstoreGroupArgs | NexusBlobstoreGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NexusBlobstoreGroupState | undefined;
            ...
            const args = argsOrState as NexusBlobstoreGroupArgs | undefined;
        ...
        super(NexusBlobstoreGroup.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface NexusBlobstoreGroupState {
    /**
     * Available space in Bytes
     */
     ...
     * Soft quota of the blobstore
     */
    softQuota?: pulumi.Input<inputs.NexusBlobstoreGroupSoftQuota>;
    /**
     * The total size of the blobstore in Bytes
     */
 ...
 */
export interface NexusBlobstoreGroupArgs {
    /**
     * The policy how to fill the members. Possible values: `roundRobin` or `writeToFirst`
     */
    fillPolicy: pulumi.Input<string>;
