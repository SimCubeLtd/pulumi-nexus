...
export class NexusSecurityLdap extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NexusSecurityLdapState, opts?: pulumi.CustomResourceOptions): NexusSecurityLdap {
        return new NexusSecurityLdap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/nexusSecurityLdap:NexusSecurityLdap';

    /**
     * Returns true if the given object is an instance of NexusSecurityLdap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NexusSecurityLdap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NexusSecurityLdap.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: NexusSecurityLdapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NexusSecurityLdapArgs | NexusSecurityLdapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NexusSecurityLdapState | undefined;
            ...
            const args = argsOrState as NexusSecurityLdapArgs | undefined;
        ...
        super(NexusSecurityLdap.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface NexusSecurityLdapState {
    /**
     * The password to bind with. Required if authScheme other than none.
     */
 ...
 */
export interface NexusSecurityLdapArgs {
    /**
     * The password to bind with. Required if authScheme other than none.
     */
    authPassword?: pulumi.Input<string>;
