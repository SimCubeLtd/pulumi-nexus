...
class Item(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```python
        import pulumi
        import simcubeltd_pulumi_nexus as nexus

        demo_password = nexus.Item("demoPassword",
            vault=var["demo_vault"],
            title="Demo Password Recipe",
            category="password",
            password_recipe=nexus.ItemPasswordRecipeArgs(
                length=40,
                symbols=False,
            ))
        demo_login = nexus.Item("demoLogin",
            vault=var["demo_vault"],
            title="Demo Terraform Login",
            category="login",
            username="test@example.com")
        demo_db = nexus.Item("demoDb",
            vault=var["demo_vault"],
            category="database",
            type="mysql",
